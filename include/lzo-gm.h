...
/* Reentrant API for the lzo-gm routine: estimates the average local-constant
   (zeroth-order) forecast error over a range of neighborhood sizes.
   Extracted out of source_c/lzo-gm.c so it can be called both from the
   lzo-gm CLI and from other bindings (e.g. Python) without going through
...
/* Estimates, for a growing sequence of neighborhood sizes, the average
   forecast error of a local-constant fit, mirroring source_c/lzo-gm.c's
